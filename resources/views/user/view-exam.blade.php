    ...
    <div class="container mt-sm-5 my-1">
        ...
        <form action="{{ route('submitExam') }}" id="examForm" method="POST">
            ...
            <div class="question ml-sm-5 pl-sm-5 pt-2">
                <div class="py-2 h5"><b>Q.{{$key+1}}) {{ $res->question }}</b></div>
                ...
                <div class="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options">
                    <label class="options">a) {{ $res->a }}
                        <input type="radio" value="a" name="option{{ $key+1 }}">
                        <span class="checkmark"></span>
                    </label>
                    <label class="options">b) {{ $res->b }}
                        <input type="radio" value="b" name="option{{ $key+1 }}">
                        <span class="checkmark"></span>
                    </label>
                    <label class="options">c) {{ $res->c }}
                        <input type="radio" value="c" name="option{{ $key+1 }}">
                        <span class="checkmark"></span>
                    </label>
                    <label class="options">d) {{ $res->d }}
                        <input type="radio" value="d" name="option{{ $key+1 }}">
                        <span class="checkmark"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="">
                <div id="prev">
                    ...
                    <button type="submit" class="submitExam btn btn-success ">Submit</button>
                </div>
            </div>
        </form>
