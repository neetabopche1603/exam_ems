              ...
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        <a href="#"><img src="{{asset('frontend/icon/loc.png')}}" alt="#" /></a>London 145
                        <br>United Kingdom </li>
                        <li>
                          <a href="#"><img src="{{asset('frontend/icon/email.png')}}" alt="#" /></a>demo@gmail.com </li>
                          <li>
                            <a href="#"><img src="{{asset('frontend/icon/call.png')}}" alt="#" /></a>+12586954775 </li>
                          </ul>
